...
C.prototype.setState = function (a, b) {
  if ("object" !== _typeof(a) && "function" !== typeof a && null != a) throw Error(z$1(85));
...
function L(a) {
  return "object" === _typeof(a) && null !== a && a.$$typeof === n$1;
}
function escape(a) {
  var b = {
    "=": "=0",
...
function O$1(a, b, c, e, d) {
  ...
  } else if ("object" === k) throw b = "" + a, Error(z$1(31, "[object Object]" === b ? "object with keys {" + Object.keys(a).join(", ") + "}" : b));
  return h;
}
function P$1(a, b, c) {
  if (null == a) return a;
...
react_production_min.cloneElement = function (a, b, c) {
  ...
  if (null != b) {
    ...
    for (f in b) {
      H.call(b, f) && !I$1.hasOwnProperty(f) && (e[f] = void 0 === b[f] && void 0 !== g ? g[f] : b[f]);
    }
  }
...
var Home = function Home(props) {
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", null, "This is home:", pathname, " "), /*#__PURE__*/React.createElement(Page, null));
};

var content = function content(props) {
  return server.renderToString( /*#__PURE__*/React.createElement(Home, props));
};
